...
public class LoginPatient extends AppCompatActivity {
    ...
    // Change this URL according to where the PHP script is
    private static final String LOGIN_URL = "http://highway2help.eirb.fr/php/Login.php";
    ...
    private void login(String email, String password) {
        class LoginUser extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(LoginPatient.this, "Please Wait",null, true, true);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                if (s.equals(result) ) {
                    Intent intent = new Intent(LoginPatient.this,HomePatient.class);
            ...
            protected String doInBackground(String... params) {
                ...
                //catch some error
                    ...
                    Toast.makeText(LoginPatient.this, ex.toString(), 1 ).show();
